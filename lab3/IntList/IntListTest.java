...
public class IntListTest {
    ...
    public void testReverse() {
        // Test that the method handles null lists properly
        IntList p1 =  new IntList();
        IntList.reverse(p1);
        IntList test_null = new IntList();
        assertEquals(test_null, p1);
        // Test that the function returns a reversed list.
        IntList p2 = IntList.list(1, 2, 3, 4);
        IntList act = IntList.reverse(p2);
        IntList exp = IntList.list(4, 3, 2, 1);
